...
//	private final ProductImageRepository productImageRepository;
	...
	public List<ProductResponseDto> getProductsByStoreManagerAndId(String productId, String storeManagerId,
			String realm) {
		Product product = productRepository.findById(productId)
				.orElseThrow(() -> new RuntimeException("Product not found"));
		if (!product.getUserId().equals(storeManagerId)) {
			throw new RuntimeException("Access denied: You are not authorized to access this product");
		}
