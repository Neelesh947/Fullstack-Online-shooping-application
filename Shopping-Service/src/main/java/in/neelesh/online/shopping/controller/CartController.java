...
public class CartController {
	...
	public ResponseEntity<Void> moveToWishlist(@PathVariable String realm, @Valid @RequestBody CartItemRequestDto dto) {
		String customerId = SecurityUtils.getCurrentUserIdSupplier.get();
		cartService.moveItemToWishlist(customerId, realm, dto.productId(), dto.quantity());
