...
public class ProductContoller {
	...
	public ResponseEntity<List<ProductResponseDto>> getStoreManagerProductsById(@PathVariable String productId,
			@PathVariable String realm) {
		String storeManagerId = SecurityUtils.getCurrentUserIdSupplier.get();
		List<ProductResponseDto> products = productService.getProductsByStoreManagerAndId(productId, storeManagerId,
				realm);
		return ResponseEntity.ok(products);
	}
	...
	public ResponseEntity<Void> deleteProduct(@PathVariable String realm, @PathVariable String productId) {
		String storeManagerId = SecurityUtils.getCurrentUserIdSupplier.get();
